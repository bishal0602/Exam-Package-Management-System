...
class Person extends React.Component {
  ...
  loadCollegeOptions = async () => {
    ...
    fetch(import.meta.env.VITE_BACKEND_URL + "API/query/getCollegeList")
      .then((res) => {
  ...
  submitForm = (event) => {
    ...
    let url = `${import.meta.env.VITE_BACKEND_URL}API/query/addPerson`;
    let methodType = "POST";
    ...
    if (this.props.match) {
      ...
      if (personID !== undefined) {
        url =
          `${import.meta.env.VITE_BACKEND_URL}API/query/editPerson/` + personID;
        methodType = "PUT";
      }
    }
  ...
  uploadFile = async () => {
    ...
    const res = await axios.post(
      import.meta.env.VITE_BACKEND_URL + "API/query/upload",
      data,
      {
    ...
    let response = await fetch(
      import.meta.env.VITE_BACKEND_URL + "API/query/postExcel",
      {
        method: "post",
        headers: {
          Accept: "application/json",
